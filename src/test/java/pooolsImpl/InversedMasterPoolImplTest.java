...
public class InversedMasterPoolImplTest {
    @Test
    public void verifyAddEmptyMesh() {
        InversedMasterPoolImpl pool = new InversedMasterPoolImpl();
    ...
    public void verifyConnectTwoEmptyPools() {
        InversedMasterPoolImpl poolFirst = new InversedMasterPoolImpl();
        InversedMasterPoolImpl poolSecond = new InversedMasterPoolImpl();
    ...
    public void verifyConnectPoolToPoolMesh() {
        InversedMasterPoolImpl poolFirst = new InversedMasterPoolImpl();
        InversedMasterPoolImpl poolSecond = new InversedMasterPoolImpl();
        InversedMasterPoolImpl poolThird = new InversedMasterPoolImpl();
    ...
    public void verifyConnectPoolMeshToPoolMeshMasterToMaster() {
        ...
        InversedMasterPoolImpl poolSecond = new InversedMasterPoolImpl();
        InversedMasterPoolImpl poolThird = new InversedMasterPoolImpl();
        InversedMasterPoolImpl poolFourth = new InversedMasterPoolImpl();
